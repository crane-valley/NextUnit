...
public class TestClass
{
    ...
    [Fact]
    public async Task NoEntryPoint_GeneratesProgramAsync()
    {
        var source = @"
using NextUnit;
...
public class TestClass
{
    ...
    public void SimpleTest()
    {
        ...
        var expectedProgramSource = @"// <auto-generated />
#nullable enable
using System.Threading.Tasks;
...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        await CSharpSourceGeneratorVerifier<NextUnitGenerator>.VerifyGeneratorAsync(
            source,
            ("Program.g.cs", expectedProgramSource));
    }

    [Fact]
    public async Task ExistingEntryPoint_DoesNotGenerateProgramAsync()
    {
        var source = @"
using NextUnit;
using System.Threading.Tasks;
...
public static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        // Verify that generator runs without errors and does NOT produce Program.g.cs
